...
- Make a list of files here.
  ...
  - /ls8 - project for week
    ...
    - README.md - steps for ls8 folder
  - FAQ.md - A LOT of Q&A stuff
  - LS8-cheatsheet.md - binary codes
  - LS8-spec.md - akin to ls8 docs
  - README.md - global readme for whole unit

- Write a short 3-10-word description of what each file does.
- Mentally note what has been implemented, and what hasn't.
